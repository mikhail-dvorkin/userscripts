...
// If your browser doesn't allow it, then install TamperMonkey extenstion, and add this userscript there.
// If you want this script to play sound, allow sounds in the settings of a tab, or run your browser with option --autoplay-policy=no-user-gesture-required.

console.log("Running: BelAvia ticket catcher, version 1.0.0");
